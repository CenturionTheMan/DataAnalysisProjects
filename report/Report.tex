...
\section{Analiza TFD dla obiektu żółta torba (yellow bag)} %TODO
    ...
    \subsection{Równość wariancji w grupach}
        Na podstawie wyników z sekcji \textit{''Normalność zmiennej w grupach''} można stwierdzić, że
        że rozkład zmiennej TFD w grupach jest normalny. 
        Dlatego do analizy równości wariancji w grupach użyto testu Levene'a. 
